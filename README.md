...
[![Status](https://img.shields.io/badge/status-v0.6.6%20%E2%80%94%20parallel%20bulk%20ingest%20%E2%80%94%20LUBM--100%20full%20pass%20%E2%80%94%20SPARQL%201.1%20%2F%20SHACL%20%2F%20OWL-brightgreen)](docs/10-roadmap.md) [![LATEST.md](https://img.shields.io/badge/LATEST.md-current%20advertised%20version-blue)](./LATEST.md)
...
| **Install** | **OCI** — `oras pull ghcr.io/styk-tv/pgrdf-bundle:0.6.6` (public, zero-cred; every digest SLSA-attested, verify with `gh attestation verify oci://ghcr.io/styk-tv/pgrdf-bundle:<tag> --repo styk-tv/pgRDF`) · **tarballs** (pg14–17 × amd64/arm64) · **PGXN** — `pgxn install pgrdf`. See [INSTALL.md](INSTALL.md). |
| **Current release** | **v0.6.6** — [LATEST.md](./LATEST.md) is authoritative at audit time |
