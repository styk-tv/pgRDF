...
[![Tests](https://img.shields.io/badge/tests-93%20pgrx%20%2B%2033%20regression%20%2B%2021%20W3C%20%2B%203%20LUBM-brightgreen)](#tests)
...
[![W3C](https://img.shields.io/badge/W3C%20SPARQL%201.1-21%20starter%20tests-blue)](tests/w3c-sparql/)
...
1, 2, and 3 (phase A) storage perf + Phase 4 OWL 2 RL inference +
Phase 5 SHACL validate (stub — see [ERRATA E-009](specs/ERRATA.v0.2.md)):
**93 pgrx integration tests + 30 regression files passing.**
External smoke covers 24
