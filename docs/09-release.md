...
The current cut is **`v0.6.7`** (`isPrerelease=false`,
`isLatest=true`); Cargo.toml + `pgrdf.control` read `0.6.7`, and the
...
cover the v0.5.x line and earlier; the full v0.6.0 → v0.6.7 history
