...
-- OCI-GERMINATION on 2026-05-30) to v0.5.32 (the first release that
-- bumps the internal version label to match the tag).
--
-- The pgrdf SCHEMA is byte-identical between 0.5.1 and 0.5.32 — every
...
-- ``ALTER EXTENSION pgrdf UPDATE TO '0.5.32'`` path valid. Its body
